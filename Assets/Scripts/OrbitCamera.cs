...
public class OrbitCamera : MonoBehaviour {
    ...
    void Update()
    {
        ...
        var lookAction = inputSystem.Player.Look;
        var lookInputState = lookAction.ReadValue<Vector2>();
        if (lookAction.activeControl?.device is Mouse) {
            lookInputState *= mouseSensitivity;
        }
	...
	bool ManualRotation () {
        Vector2 input = new Vector2(rotation.y, rotation.x);
